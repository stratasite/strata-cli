    ...
    class Credentials
      ...
      def collect
        ...
        when "snowflake"
          ...
          case auth_mode
          when "pat"
            credentials["personal_access_token"] = ask("Personal Access Token:", echo: false)
          when "kp"
          ...
          when "oauth"
            ...
            credentials["oauth_client_secret"] = ask("OAuth Client Secret:", echo: false)
        ...
        when "athena"
          ...
          credentials["secret_access_key"] = ask("AWS Secret Access Key:", echo: false)
        else
          if required?
            credentials["username"] = ask("Username:", echo: false)
            credentials["password"] = ask("Password:", echo: false)
          end
        end
